...
## 2023-11-24
 -- 修复提交预约医院名称不显示问题<br>
 -- 修复排班修改剩余预约数量不同步问题<br>
 -- 替换测试数据为`数据备份.sql`，此部分数据对应的图片不存在，请自行编辑或删除<br>
 -- 修复`医生名下`关闭弹窗左侧导航不切换问题<br>
 -- 修复小程序在特定日期下获取周次错误问题
## 2022-11-10
 -- 优化小程序同科室医生推荐逻辑<br>
 -- 修复管理端二级科室搜索问题<br>
 -- 修复小程序部分账号在余额退款功能中提示无权限问题<br>
 -- 修复小程序部分获取医生一周内排班时一程问题<br>
 -- 新增完成预约时向用户发送消息的功能<br>
 -- 新增完成预约时扣款失败创建订单后向用户发送消息功能
## 2022-11-09
 -- 修复医院开关失效问题<br>
 -- 修复提交预约时医院获取失败的问题<br>
 -- 修复排班剩余可预约数量异常bug<br>
...
## 结构
```
此项目包含三部分，分别是小程序端，管理员端，接口api；对应根目录为Applet，Admin，Api
```
## 小程序部分
整体功能有：
```
