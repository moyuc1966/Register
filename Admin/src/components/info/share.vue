...
export default {
    ...
    methods: {
        ...
        handleCurrentChange(val) {
            ...
            this.$http.get(`api/article?cat=分享&page=${this.currentPage}&limit=${this.pageSize}`).then(res => {
        ...
        getInfo() {
            ...
            this.$http.get('api/article?cat=分享&limit=12&page=1').then(res => {
                loading.close()
                if (res.data.code == 200) {
                    this.list = res.data.data;
        ...
        searchBind() {
            ...
            this.$http.get(`api/articlePut/${this.search}?page=1&limit=12&cat=分享`).then(res => {
                loading.close()
                if (res.data.code == 200) {
                    this.list = res.data.data
        ...
        // 全部导出，请求全部数据
        exportDataoz() {
            this.$http.get(`api/article?cat=分享&page=1&limit=${this.count}`).then(res => {
                if (res.data.code == 200) {
        ...
        exportNewList(arr) {
            ...
            XLSX.utils.book_append_sheet(bookNew, workSheet, "公告列表");
            let name = "公告明细.xlsx";
            loading.close()
